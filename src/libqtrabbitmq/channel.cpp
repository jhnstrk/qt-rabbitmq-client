...
QFuture<void> Channel::queueUnbind(const QString &queueName, const QString &exchangeName)
{
...
bool Channel::basicNack(quint64 deliveryTag, bool muliple, bool requeue)
{
    ...
    QVariantList args({deliveryTag, muliple, requeue});
